      ...
      setMessages([
        {
          id: 'welcome',
          type: 'bot',
          content: 'Hello! I\'m your AI healthcare assistant. I can help you with hospital-related queries, general health information, and medical guidance. How can I assist you today?',
          timestamp: new Date()
        }
      ]);
    }
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-teal-700 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 z-50 flex items-center justify-center"

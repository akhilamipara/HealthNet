        ...
        <div>
            ...
            <div className="w-full h-[250px] sm:h-[350px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-lg mb-6">
                <video 
                    ...
                    src="/src/assets/video.mp4"  // <-- place your video in public/videos
                    autoPlay
                    loop
                    muted
                    playsInline
            ...
            {/* --------- Header Section --------- */}
            <div className='flex flex-col md:flex-row flex-wrap bg-teal-700 rounded-lg px-6 md:px-10 lg:px-20 '>

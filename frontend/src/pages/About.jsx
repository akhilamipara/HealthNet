    ...
    <div className="px-6 md:px-12 lg:px-20 py-12">
      ...
      <div className="text-center mb-12" data-aos="fade-up">
        <h2 className="text-4xl font-bold text-gray-800">
          About <span className="text-teal-700">HealthNet</span>
        </h2>
        <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
          HealthNet is your trusted healthcare partner, combining technology with care to
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 items-center">
        ...
        >
          <p>
            At HealthNet, we understand the 
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-20">
        <div 
          className="border rounded-2xl p-8 flex flex-col items-center text-center gap-5 
                     hover:bg-teal-700 hover:text-white transition-all duration-300 shadow-md"
          data-aos="zoom-in" data-aos-delay="100"
        >
          <Clock className="w-12 h-12 text-teal-700 hover:text-white transition-colors" />
        ...
        >
          <Users className="w-12 h-12 text-teal-700 hover:text-white transition-colors" />
        ...
        >
        <HeartPulse className="w-12 h-12 text-teal-700 hover:text-white transition-colors" />

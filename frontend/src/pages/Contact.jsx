...
const Contact = () => {
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen px-6 md:px-20">
      ...
      {/* Heading */}
      <div 
        className="text-center text-3xl pt-10 text-teal-700 font-light tracking-wider"
        data-aos="fade-down"
      >
        <p>
      ...
      >
        ...
        >
          ...
          <p className="text-gray-500">
            Tel: +91 9714745461 <br /> 
            <Mail className="inline mr-2" size={18}/> healthnet@gmail.com
          </p>

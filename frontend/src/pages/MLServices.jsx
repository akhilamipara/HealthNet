...
const MLServices = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8" data-aos="fade-up">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Tab Navigation */}
        <div className="flex flex-wrap justify-center mb-8" data-aos="fade-up">
          {[
            ...
            <div className="space-y-6" data-aos="fade-right">
              ...
              <div className="max-w-2xl mx-auto" data-aos="fade-up">
                <textarea
                  ...
                  className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-700 focus:border-transparent resize-none"
                  rows="4"
                />
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full mt-4 bg-teal-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  data-aos="zoom-in"
                >
                ...
                {symptomResult && (
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-teal-200" data-aos="fade-left">
                    <h3 className="font-semibold text-teal-900 mb-2">Analysis Results</h3>
            ...
            <div className="space-y-6" data-aos="fade-left">
              ...
              <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4" data-aos="fade-up">
                <input
                  ...
                  className="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-700 focus:border-transparent"
                />
              ...
              <div className="max-w-4xl mx-auto" data-aos="fade-up">
                <textarea
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-700 focus:border-transparent resize-none"
                  rows="3"
                />
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-700 focus:border-transparent resize-none mt-4"
                  rows="3"
                />
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full mt-4 bg-green-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  data-aos="zoom-in"
                >
                ...
                {diseaseResult && (
                  <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200" data-aos="fade-right">
            ...
            <div className="space-y-6" data-aos="fade-right">
              ...
              <div className="max-w-2xl mx-auto" data-aos="fade-up">
                <input
                  ...
                  className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-700 focus:border-transparent"
                />
                ...
                {treatmentResult && (
                  <div className="mt-6 p-4 bg-teal-50 rounded-lg border border-purple-200" data-aos="fade-left">
                    <h3 className="font-semibold text-teal-900 mb-4">Treatment Information for {treatmentResult.disease_name}</h3>
